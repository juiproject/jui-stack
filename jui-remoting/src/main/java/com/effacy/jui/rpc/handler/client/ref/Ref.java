...
/**
 * Base class for reference specifications (these express the manner in which an
 * entity is referenced and obtained for action).
 *
 * @author Jeremy Buckley
 */
@JsonSerializable(settersRequired = false, type = TypeMode.SIMPLE)
public abstract class Ref extends Remote {
