...
/**
 * Implemented to pick up any non-navigable residual.
 *
 * @author Jeremy Buckley
 */
public interface INavigationResidualAware {

    /**
     * Notify the residual components of the navigation path.
     * 
     * @param ctx
     *                 the navigation context.
     * @param residual
     *                 the residual components (if any).
     */
