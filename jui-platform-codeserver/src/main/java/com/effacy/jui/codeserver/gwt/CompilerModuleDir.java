 ...
 * the unit cache.
 */
public class CompilerModuleDir {
     ...
     */
    public static CompilerModuleDir create(File dir, TreeLogger logger) throws IOException {
        ...
        return new CompilerModuleDir(dir);
    }
     ...
     * @see #create
     */
    private CompilerModuleDir(File root) {
        this.root = root;
    }
     ...
     */
    public CompileDir makeCompileDir(TreeLogger logger) throws UnableToCompleteException {
