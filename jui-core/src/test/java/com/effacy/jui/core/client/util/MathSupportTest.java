...
public class MathSupportTest {
    ...
    @Test
    public void bin_02() {
        List<Number> values = Arrays.asList(2, 2, 3);
        MathSupport.BinStatistics stats = MathSupport.bin(values, 1.0, 1.0, 7);

        Assertions.assertEquals(3, stats.n());

        MathSupport.Bin[] bins = stats.data();
        Assertions.assertEquals(7, bins.length);
        ...
        Assertions.assertEquals(0, bins[0].n());
        Assertions.assertEquals(2, bins[1].n());
        Assertions.assertEquals(1, bins[2].n());
        Assertions.assertEquals(0, bins[3].n());
        Assertions.assertEquals(0, bins[4].n());
        Assertions.assertEquals(0, bins[5].n());
        Assertions.assertEquals(0, bins[6].n());

        Assertions.assertEquals(0.0, bins[0].p());
        Assertions.assertEquals(1.0, bins[1].p(), 0.005);
        Assertions.assertEquals(0.5, bins[2].p(), 0.005);
        Assertions.assertEquals(0.0, bins[3].p());
        Assertions.assertEquals(0.0, bins[4].p());
        Assertions.assertEquals(0.0, bins[5].p());
        Assertions.assertEquals(0.0, bins[6].p());
    }
}
