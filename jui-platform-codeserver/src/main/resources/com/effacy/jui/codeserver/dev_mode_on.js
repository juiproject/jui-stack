...
(function() {
  ...
  function makeDialog() {
    ...
    dialog.style.zIndex = 9000001;
    dialog.style.position = 'fixed';
    dialog.style.top = '20pt';
    dialog.style.left = '20pt';
    dialog.style.right = '20pt';
    dialog.style.color = '#33475b';
    dialog.style.background = 'white';
    dialog.style.border = '1px solid #ccc';
    dialog.style.padding = '1.5em 1.75em 1.25em 1.75em';
    dialog.style.borderRadius = '8px';
    dialog.style.boxShadow = '0 0 10px 0 rgba(0, 0, 0, 0.5)';
    dialog.style.wordBreak = 'break-word';
    dialog.style.fontFamily = 'Helvetica';
  ...
  function makeBookmarklet(name, javascript) {
    ...
    result.style.background = '#0fa1be';
    result.style.padding = '0.5em 1em';
  ...
  function makeCleanCompileBookmarklet(codeserver_url, module_name) {
    var bookmarklets_js = codeserver_url + 'dev_mode_on.js';
    var javascript = '{ window.__gwt_bookmarklet_params = {'
        + 'server_url:\'' + codeserver_url + '\','
        + 'module_name:\'' + module_name + '\'};'
        + ' var s = document.createElement(\'script\');'
        + ' s.src = \'' + bookmarklets_js + '?clean=true\';'
        + ' void(document.getElementsByTagName(\'head\')[0].appendChild(s));}';
    return makeBookmarklet('Clean and compile', javascript);
  }
  ...
  function showModuleDialog(codeserver_url) {
    ...
    function makeModuleRows(mod) {
      ...
      var moduleColor = error ? '#ccc' : '#33475b';
      ...
      if (!error) {
        ...
        // button = makeCleanCompileBookmarklet(codeserver_url, module_name);
        // button.className = 'module_' + module_name;
        // cell = $doc.createElement('td');
        // cell.style.paddingLeft = '1em';
        // cell.appendChild(button);
    ...
    moduleTable.style.margin = "1em 0";
  ...
  function showCompilingDialog(text) {
    ...
    result.showError = function(errorText, log_url, onClickTryAgain) {
      var error = makeTextElt('a', '0.8em', errorText);
      ...
      button.style.background = '#0fa1be';
      ...
      var action = makeTextElt('a', '1.1em', 'view log');
      action.setAttribute('href', log_url);
      action.setAttribute('target', 'gwt_dev_mode_log');
      action.style.color = '#0fa1be';
      action.style.textDecoration = 'none';
      action.style.marginLeft = '1em';
