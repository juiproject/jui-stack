...
public class Input {
     ...
     */
    @SafeVarargs
    public static ElementBuilder $(String type, Consumer<ElementBuilder>... builder) {
        return DomBuilder.input (type, builder);
    }
     ...
     * @return the newly created element.
     */
    public static ElementBuilder $(IDomInsertableContainer<?> parent, String type) {
        ElementBuilder el = $ (type);
        parent.insert (el);
        return el;
    }
}
