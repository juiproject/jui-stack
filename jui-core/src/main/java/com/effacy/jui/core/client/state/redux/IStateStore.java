...
public interface IStateStore<S> extends IStateMutator<S> {
    
    /**
     * Registers a suubscriber.
     * 
     * @param subscriber
     *                   the subscriber to register.
     * @return a handler for the subscriber.
     */
    public SubscriberHandler subscribe(Subscriber<S> subscriber);

    /**
     * Captures control information about a subscriber.
     */
