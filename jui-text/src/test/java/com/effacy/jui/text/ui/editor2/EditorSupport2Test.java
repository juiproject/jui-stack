...
public class EditorSupport2Test {
    ...
    public void testCharCount_plainText() throws Exception {
        try (WebClient webClient = new WebClient()) {
            ...
            HtmlPage page = webClient.loadHtmlCodeIntoCurrentWindow(load("EditorSupport2Test.html", content));
    ...
    public void testMoveCursorToStart() throws Exception {
        try (WebClient webClient = new WebClient()) {
            HtmlPage page = webClient.loadHtmlCodeIntoCurrentWindow(load("EditorSupport2Test.html", CELL_CONTENT));
    ...
    protected String load(String file) throws Exception {
        try (InputStream is = EditorSupport2Test.class.getResourceAsStream(file)) {
    ...
    protected String loadEditorJs() throws Exception {
        try (InputStream is = EditorSupport2Test.class.getResourceAsStream("/com/effacy/jui/text/public/jui_text_editor2.js")) {
