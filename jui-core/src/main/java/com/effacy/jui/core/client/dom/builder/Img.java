...
public class Img {
     ...
     * 
     * @param src
     *                the source URI for the anchor.
     * @param builder
     *                the builders to apply.
     * @return the newly created element.
     */
    @SafeVarargs
    public static ElementBuilder $(String src, Consumer<ElementBuilder>... builder) {
        return DomBuilder.img (src, builder);
    }
     ...
     * @return the newly created element.
     */
    public static ElementBuilder $(IDomInsertableContainer<?> parent, String src) {
        ElementBuilder el = $ (src);
        parent.insert (el);
        return el;
    }
}
