...
public class Custom {
     ...
     */
    @SafeVarargs
    public static ElementBuilder $(String name, Consumer<ElementBuilder>... builder) {
        return DomBuilder.custom (name, builder);
    }
     ...
     */
    @SafeVarargs
    public static ElementBuilder $(IDomInsertableContainer<?> parent, String name, Consumer<ElementBuilder>... builder) {
        ElementBuilder el = $ (name);
        parent.insert (el);
        return el;
    }
}
